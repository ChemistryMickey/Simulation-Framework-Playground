...
- Steal from Financial Monte Carlo
	- [x] Convert to Bazel once you're back on something more powerful than a chomebook
		- Also, figure out how not to invalidate the cache between config builds. That's annoying
	- [x] Convert to GCC > 12 once you're back on something more powerful than a chromebook
...
- [x] Build things as a library rather than an application
