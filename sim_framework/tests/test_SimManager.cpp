...
TEST_F(TestSimManager, ActivateDeactivateJob) {
  ...
  simManager.run();
  EXPECT_EQ(
      simManager.deactivated_phases[activateDeactivateJob.phase][0].procCounter,
      2);
}
