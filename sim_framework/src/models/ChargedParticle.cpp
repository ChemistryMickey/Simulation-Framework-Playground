...
ChargedParticle::ChargedParticle(Integrator<DATATABLE_COLS> &integrator,
                                 Eigen::Vector3d &localMagField_,
                                 double charge_C_, double mass_kg_)
    : Model<3>{integrator}, localMagField{localMagField_}, charge_C{charge_C_},
      mass_kg{mass_kg_} {}
...
Eigen::Vector3d
ChargedParticle::elecfield_at_point(const Eigen::Vector3d &pos) {
